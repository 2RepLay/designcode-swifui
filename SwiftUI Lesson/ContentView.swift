...
//  SwiftUI Lesson
//
//  Created by Никита Янков on 02.05.2020.
...
struct BottomCardView: View {
    ...
    var body: some View {
        VStack(spacing: 20) {
            ...
            Text("This certificate is proof that Meng To has achieved the UI Design course with approval from a a Design+Code instructor.")
